...
public class UnitTests
{
    ...
    public void ProjectLoadTest()
    {
        ProjectManager manager = new ProjectManager(
            Resources.TemplateDirectory,
            Resources.CurrentDirectory
        );
    ...
    public void AnimationDataSingleFileTest()
    {
        ...
        FileInfo inputFile = new(
            Path.Combine(Resources.TemplateDirectory.FullName, animDataFileName)
        );
        ...
        FileInfo outputFile = new(
            Path.Combine(Resources.OutputDirectory.FullName, animDataFileName)
        );

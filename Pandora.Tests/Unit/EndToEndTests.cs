...
public sealed class DependencyInjectedCluster : IDisposable
{
	...
	public DependencyInjectedCluster()
	{
		...
		var pandoraEngineDir = _outputDir.CreateSubdirectory("Pandora_Engine");
		var meshesDir = _outputDir.CreateSubdirectory("meshes");
		...
		userPathsSub.Output.Returns(_outputDir);

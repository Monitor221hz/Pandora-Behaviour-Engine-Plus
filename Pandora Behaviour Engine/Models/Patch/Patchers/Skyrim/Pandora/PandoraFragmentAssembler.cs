...
namespace Pandora.Patch.Patchers.Skyrim.Pandora
{
    ...
    public class PandoraFragmentAssembler
    {
        ...
        private DirectoryInfo engineFolder = new DirectoryInfo(Path.Combine(Directory.GetCurrentDirectory(), "Pandora_Engine"));

        private DirectoryInfo templateFolder = new DirectoryInfo(Path.Combine(Directory.GetCurrentDirectory(), "Pandora_Engine", "Skyrim", "Template"));

        private DirectoryInfo defaultOutputMeshFolder = new DirectoryInfo(Path.Combine(Directory.GetCurrentDirectory(), "meshes"));

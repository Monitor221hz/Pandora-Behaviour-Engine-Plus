...
public class FNISParser
{
	...
	{
		var currentDirectory = new DirectoryInfo(Path.Join((BehaviourEngine.SkyrimGameDataDirectory ?? BehaviourEngine.AssemblyDirectory).FullName, project.ProjectFile.RelativeOutputDirectoryPath));

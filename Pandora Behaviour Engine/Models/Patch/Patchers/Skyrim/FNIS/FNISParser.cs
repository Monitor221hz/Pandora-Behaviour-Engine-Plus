...
public class FNISParser
{
    ...
    {
        var currentDirectory = new DirectoryInfo(Path.Join((BehaviourEngine.GameDirectory ?? BehaviourEngine.AssemblyDirectory).FullName, project.ProjectFile.RelativeOutputDirectoryPath));
    ...
    private bool InjectGraphReference(FileInfo sourceFile, PackFileGraph destPackFile)
    {
        ...
        string graphPath = Path.Combine(destPackFile.InputHandle.Directory?.Name, $"{nameWithoutExtension}.hkx");

...
public partial class PatchBox : ReactiveUserControl<EngineViewModel>
{
    ...
    private void ModInfoDataGrid_AttachedToVisualTree(object? sender, VisualTreeAttachmentEventArgs e)
	{
        ...
        var savedColumn4 = Properties.GUISettings.Default.PatchBoxPriorityColumnWidth;
        ...
        ModInfoDataGrid.Columns[4].Width = savedColumn4 > 1 ? new DataGridLength(savedColumn4) : ModInfoDataGrid.Columns[4].Width;
        ModInfoDataGrid.Columns[5].Width = savedColumn5 > 1 ? new DataGridLength(savedColumn5) : ModInfoDataGrid.Columns[5].Width;

        ModInfoDataGrid.Columns[1].IsVisible = Properties.GUISettings.Default.PatchBoxNameColumnVisible;
        ...
        ModInfoDataGrid.Columns[4].IsVisible = Properties.GUISettings.Default.PatchBoxPriorityColumnVisible;
        ModInfoDataGrid.Columns[5].IsVisible = Properties.GUISettings.Default.PatchBoxCodeColumnVisible;
    }
	...
	private void ModInfoDataGrid_DetachedFromLogicalTree(object? sender, LogicalTreeAttachmentEventArgs e)
	{
        ...
        Properties.GUISettings.Default.PatchBoxPriorityColumnWidth = ModInfoDataGrid.Columns[4].Width.Value;
        Properties.GUISettings.Default.PatchBoxCodeColumnWidth = ModInfoDataGrid.Columns[5].Width.Value;

        Properties.GUISettings.Default.PatchBoxNameColumnVisible = ModInfoDataGrid.Columns[1].IsVisible;
        ...
        Properties.GUISettings.Default.PatchBoxPriorityColumnVisible = ModInfoDataGrid.Columns[4].IsVisible;
        Properties.GUISettings.Default.PatchBoxCodeColumnVisible = ModInfoDataGrid.Columns[5].IsVisible;
    }
}